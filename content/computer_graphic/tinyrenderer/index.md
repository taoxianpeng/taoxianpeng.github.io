...
<img src="bresenham-flowchart.svg" width="60%">
...
![优化光栅化遍历三角形区域](rasterization_frame.svg)
...
4. vertex改造
    - 根据传入来的灯光视角下的MVP矩阵 将当前顶映射到灯光视角下`light_world_pos`，然后传入管线中光栅化处理到片段着色器.
5. fragment改造
